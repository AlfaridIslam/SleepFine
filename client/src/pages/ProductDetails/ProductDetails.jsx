...
const ProductDetails = () => {
  ...
  // Find product in context using switch-case
  const findProduct = () => {
    switch (productType) {
      case "mattress":
        return products.mattress || null;
      case "bed":
        return products.beds || null;
      case "sofa":
        return products.sofas || null;
      case "accessory":
        return products.accessories || null;
      default:
  ...
  // Event handlers
  const handleMouseEnter = () => setMagnifyStyle({ display: "block" });
  const handleMouseLeave = () => setMagnifyStyle({ display: "none" });
  const handleToggleZoom = () => setZoom((prevZoom) => !prevZoom);
  ...
  const hideMagnifyGlass = () => setMagnifyStyle({ display: "none" });
  ...
  return (
    <>
      <Link
        to="/"
        className="back cursor-pointer absolute rounded-md bg-red-300 text-black xl:text-[13px] xl:top-[160px] xl:left-[30px] xl:py-[2px] xl:pr-[22px] xl:pl-[25px] xl:px-0 xl:ml-0 xl:mt-0 sm:text-lg sm:px-4 sm:ml-8 sm:mt-4 sm:p-[12px]"
      >
        BACK
      </Link>
      <div className="product-details-container sm:mt-[72px] sm:w-[100%] p-6 flex gap-8 relative xl:mt-10 flex-col sm:flex-col xl:flex-row">
        {/* Product image and zoom functionality */}
        ...
        {/* Product details and enquiry button */}
        <div className="flex-1">
          ...
          <div className="text-gray-600">
            ...
            <h1 className="font-mono text-sky-700 sm:w-[120%] xl:w-full text-center mt-4">
              ...
              <a
                ...
                className="animate-pulse text-blue-600 hover:underline cursor-pointer ml-1"
              >
                click here
              </a>
            </h1>
