  ...
  >
    ...
    <div className="p-2 sm:p-4 xl:p-6 flex items-center justify-between sm:col-span-1 sm:row-span-1 xl:gap-60 ">
      <div>
        ...
        <h1 className="sm:mt-4 xl:mt-4 xl:-ml-2 sm:-ml-2  " >Terms and Conditions apply</h1>
      </div>
      <div>
        <h2 className="text-lg sm:text-xl xl:text-4xl xl-mt-10 sm:-mt-16 sm:-ml-40  ">Warranty Card</h2>
      </div>
    </div>
