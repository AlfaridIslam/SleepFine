...
const Footer = () => {
  return (
    <div className=' fotter-main-sec bg-black xl:w-full sm:w-[158%] text-white '>


<div className="fotter-text-sec sm:grid sm:grid-cols-2 sm:gap-4 xl:flex gap-4 justify-between items-stretch px-10 xl:h-[380px] mt-4">
